...
//function that will be used to get a specific movie
function getMovies() {
    fetch(db)
    .then(res => res.json())
    .then(movies => {
...
// function that will renders the movies' list
...
function handleBuyTicket(e) {
    ...
    // Alerts the user if the tickets are depleted
    else if (tickets == 0) {
        alert("Tickets Sold-out!!");
        // Sold out if the tickets are not available
